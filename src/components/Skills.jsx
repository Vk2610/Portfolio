...
const skillsData = {
  Frontend: [
    ...
    {
      name: 'Bootstrap',
      icon: <FaBootstrap className="text-[#7952B3]" size={28} />,
      color: 'rgba(121, 82, 179, 0.15)',
    },
    {
      name: 'Shadcn UI',
      icon: <div className="text-white font-semibold text-lg">///</div>,
  ...
  Backend: [
    {
      name: 'Node.js',
      icon: <FaNodeJs className="text-[#339933]" size={28} />,
      color: 'rgba(51, 153, 51, 0.15)',
    },
    {
      name: 'Express.js',
      icon: <SiExpress className="text-white" size={26} />,
      color: 'rgba(255, 255, 255, 0.1)',
    },
    {
      name: 'Python',
      icon: <SiPython className="text-[#3776AB]" size={26} />,
      color: 'rgba(55, 118, 171, 0.15)',
    },
    {
      name: 'Firebase',
      icon: <SiFirebase className="text-[#FFCA28]" size={26} />,
  ...
  Database: [
    ...
    {
      name: 'MySQL',
      icon: <SiMysql className="text-[#4479A1]" size={28} />,
  ...
  'Tools & Others': [
    ...
    {
      name: 'VS Code',
      icon: <VscVscode className="text-[#007ACC]" size={26} />,
      color: 'rgba(0, 122, 204, 0.15)',
    },
    {
      name: 'Postman',
      icon: <SiPostman className="text-[#FF6C37]" size={26} />,
      color: 'rgba(255, 108, 55, 0.15)',
    },
    {
      name: 'Figma',
      icon: <FaFigma className="text-[#F24E1E]" size={26} />,
